"use client"
import { deleteCustomerByIdMDB } from "@/netlify/functions/deleteCustomerAction";
...
export default function ModalDeleteCustomer({
  ...
  (PRODUCTID: string, PORODUCTNAME: string) => async () => {
    try {
      const res: any = await deleteCustomerByIdMDB(PRODUCTID);
      //close modal
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-4 md:p-5 text-center">
              ...
              <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                Are you sure you want to delete this customer: {customer!.full_name} --product :{customer!.product}-- ?
              </h3>
              <button
                onClick={deleteProduct(customer!.id, customer!.full_name)}
                type="button"
